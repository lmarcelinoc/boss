        ...
        <div>
          <div className="mb-5 sm:mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Create your account and get started today! Your organization will be created when you first log in.
            </p>
          </div>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-6">
                ...
                {/* Organization info - removed per architecture (tenant created on first login) */}
