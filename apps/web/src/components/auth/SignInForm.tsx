...
export default function SignInForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('📝 SignInForm: Login result received:', result);

      if (result.success) {
        console.log('✅ SignInForm: Login successful, setting up redirect');
        ...
        console.log('📝 SignInForm: Redirect setup', {
          redirectUrl,
          targetUrl
        });
        ...
        setTimeout(() => {
          console.log('🔄 SignInForm: Redirecting to:', targetUrl);
          router.push(targetUrl);
        }, 1000);
      } else if (result.requiresMfa) {
        console.log('🔐 SignInForm: MFA required');
        setRequiresMfa(true);
        setError("Please enter your two-factor authentication code.");
      } else {
        console.error('❌ SignInForm: Login failed:', result.error);
      ...
      setLoading(false);
      console.log('📝 SignInForm: Form submission completed');
    }
  };
